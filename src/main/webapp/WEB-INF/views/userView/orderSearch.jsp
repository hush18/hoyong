			...
			<div>
				...
				<div class="search_box_hy">
					...
					<div style="margin-top: 5px;">
						<span>
							<button class="block_btn_hy" id="button_fir">15일이내</button>
							<button class="block_btn_hy" id="button_sec">1개월</button>
							<button class="block_btn_hy" id="button_thi">3개월</button>
							<button class="block_btn_hy" id="button_for">6개월</button>
						</span>
					</div>
					<div style="margin-top: 5px;">
